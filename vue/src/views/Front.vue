...
<!--            <el-menu-item index="/front/home">前台首页</el-menu-item>-->
      ...
      <div class="search-bar">
        <el-input size="medium" style="width: 240px" v-model="keyword" @clear="clearSearch" clearable
                  placeholder="搜索商品"></el-input>
        <el-button size="medium" @click="search"
                   style="margin-left: 5px;background-color: #ff6700;color: white;border: none;cursor: pointer;">
