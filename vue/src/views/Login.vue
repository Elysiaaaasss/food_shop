...
import {User, Lock, Key, DataAnalysis,Discount} from '@element-plus/icons-vue'
...
.login-container {
  ...
  background: linear-gradient(135deg, #f8f0f5 0%, #f3d7e3 100%);/*背景色*/
  position: relative;
  overflow: hidden;
}
...
.background-shapes {
  ...
  .shape {
    ...
    &-1 {
      width: 300px;
      height: 300px;
      /*background: linear-gradient(45deg, rgba(217, 64, 140, 0.1) 0%, rgba(217, 64, 140, 0.05) 100%);*/
...
.login-left {
  width: 40%;
  background: linear-gradient(135deg, #e8b4d6 0%, #d17ba3 100%);
