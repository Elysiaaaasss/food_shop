...
const save = () => {
  ...
  request.post("/cart", form.value).then(res => {
    if (res.code === '200') {
...
<template>
  <div class="content-container">
    ...
    <div class="header-section">
      <el-input v-model="searchForm.keyword" placeholder="请输入商品id" class="filter-input" :prefix-icon="Search" clearable/>
    ...
    <el-dialog v-model="dialogFormVisible" :title="form.id ? '编辑' : '新增'" width="30%" center>
      <el-form :model="form" label-width="100px">
        <el-form-item label="商品">
          <el-select v-model="form.goodsId" placeholder="请选择商品" style="width: 220px">
        ...
        <el-form-item label="商家">
          <el-select v-model="form.unitId" placeholder="请选择商家" style="width: 220px">
            <el-option v-for="item in units" :key="item.id" :label="item.nickname" :value="item.id" />
          </el-select>
        </el-form-item>
