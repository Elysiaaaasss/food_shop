...
import { ArrowRight, ShoppingCart, StarFilled, Bell, Location,House } from '@element-plus/icons-vue'
...
const loadCategory = () => {
  request.get("/type/praise").then(res => {
    ...
    <div class="top-section">
      ...
      <div class="user-sidebar">
        ...
        <div class="login-prompt">
          ...
          <div class="login-desc">{{ isGuest ? '嗨！欢迎光临宝鸡美食推广商城' : '宝鸡美食推广' }}</div>
        </div>
        <div>
          <el-button type="primary" class="login-btn" @click="isGuest ? router.push('/login') : router.push('/front/orders')">
            {{ isGuest ? '立即登录' : '查看个人订单' }}
          </el-button>
          <el-button type="warning" class="login-btn" @click="router.push('/front/article')">
            查看文章专区
          </el-button>
        </div>
